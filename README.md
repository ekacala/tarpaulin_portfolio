...
## Postman Collection
Within the Postman folder in this repository, I have included a Postman collection and environment file containing example requests and a series of automated tests.  
### How to Use
<ol>
